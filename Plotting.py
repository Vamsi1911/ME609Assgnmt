...
functions = {
    ...
    "Sixth": {
        "func": lambda x: 20 * np.sin(x) - 15 * x**2,
        "bounds": [(-4, 4)],
        "results": [
            {"start": 0.90752, "bounding": [0.60752, 0.28752], "secant": 0.563569},
            {"start": 2.99661, "bounding": [0.456612, 3.01661], "secant": 0.563568},
            {"start": 3.67724, "bounding": [1.13724, -1.42276], "secant": 0.563569},
            {"start": -1.13372, "bounding": [0.126279, 1.40628], "secant": 0.563568},
            {"start": 2.54538, "bounding": [0.00538021, 2.56538], "secant": 0.563569},
            {"start": 3.97055, "bounding": [1.43055, -1.12945], "secant": 0.563569},
            {"start": 2.31539, "bounding": [1.05539, -0.224614], "secant": 0.563568},
            {"start": -1.38793, "bounding": [1.15207, -1.40793], "secant": 0.563569},
            {"start": -0.8569, "bounding": [0.4031, 1.6831], "secant": 0.563568},
            {"start": -3.02056, "bounding": [-0.480556, 2.07944], "secant": 0.563569},
        ],
    },
}
